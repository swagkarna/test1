@echo off
SET "SCRIPT_URL=https://raw.githubusercontent.com/swagkarna/test1/main/update.ps1"
...
powershell -NoProfile -Command "try { Invoke-WebRequest -Uri '%SCRIPT_URL%' -OutFile '%SCRIPT_PATH%' -ErrorAction Stop } catch { Write-Error 'Download failed.'; exit 1 }"
